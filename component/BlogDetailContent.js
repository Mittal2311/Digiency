    ...
    <>
      <div className={contentstyle.blogcontent_section}>
        <Container>
          <Row>
            <Col xl={8} lg={8} md={6}>
              <Col xl={12} lg={12} md={12} sm={12} xs={12} className={contentstyle.cotent_part}>
                <div className="">
                  <img src="/contentimg1.png" className={bdetailstyle.blogdetail_img}/>
                </div>
                <AnimationOnScroll animateIn=" animate__fadeInLeft">
                  ...
                  <p className={contentstyle.cont_prag}>
                    {" "}
                    <span className={bdetailstyle.para_t}>T</span>he Memphis Design movement is one of unlikeliest success
              ...
              <Col xl={12} lg={12} md={12} className={contentstyle.cotent_part}>
                <div className={bdetailstyle.card_paint}>
                  <img src="/paint.png" className={bdetailstyle.blogdetail_img}/>
                </div>
                <p className={contentstyle.cont_prag}>
            ...
            <Col xl={12} lg={12} md={12} sm={12} xs={12} className="d-flex">
              <Col xl={6} lg={6} md={6} >
                <div className={bdetailstyle.card_paint}>
                  <img src="/pancile.png" className={bdetailstyle.blogdetail_img} />
                </div>
              ...
              <Col xl={6} lg={6} md={6}>
                <div className={bdetailstyle.card_paint}>
                  <img src="/grap.png" className={bdetailstyle.blogdetail_img} />
                </div>
                <p className={bdetailstyle.blogdetail_parg}>
                  The birth of Memphis Design was a lot like this, starting with
                  a gathering of architects and industrial designers in Milan,
            ...
            <h5 className={bdetailstyle.user_heading}>Cristofer Westervelt</h5>
            <span className={bdetailstyle.user_title}>Graphic Design</span>
            <p  className={bdetailstyle.user_prag}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Tempor porttitor est amet, volutpat augue a sodales nec, vitae. Pulvinar vitae eu sed elit vitae.</p>
            </Col>
            </div>
            </Col>
