...
import Style from "../../styles/blog2design/footer.module.css";
        ...
        <div className={Style.secund_container}>
          <Container>
            <div className={Style.secund_container_div}>
              <p  className={Style.secund_container_div_p}>© Copyright 2021. All Right Reserved By Ojjomedia</p>
              <Image src="./Blog-img/arrow-up-fill.svg"  className={Style.secund_container_div_img}/>
            </div>
          </Container>
        </div>
      </div>
