            ...
            <Row>
              <Col xl={12} lg={12} md={12} sm={12} xs={12}>
                ...
                <h6 className={Style.Blogpart_h6}>
                  ...
                  rail against and confound elite sensibilities. The result was
                  a style that was revolutionary in its time and whose spirit is
                  a continual source of inspiration to this day.
                </h6>
                <h6 className={Style.Blogpart_h6}>
                  As popular and influential as Memphis Design has been over the
                  years, it can sometimes get a bad rap. It is a loud, colorful
                  style that is hard to separate from its era. And when
                  implemented without care, it can make some design projects
                  feel antiquated. On the other hand, a good designer can turn
                  these sins into virtues: obnoxious retro becoming lively
                  nostalgia.
                </h6>
                <h6 className={Style.Blogpart_h6}>
              ...
              <Col xl={12} lg={12} md={12} sm={12} xs={12}>
                ...
                <h6 className={Style.Blogpart_h6}>
                  Imagine you’re at a party, and you’re bored. You’ve been bored
                  for a while—years, it feels like. You wonder how a party,
                  something that is supposed to be fun, can feel like it’s
                  draining the life out of your very soul. As you look around
                  the yawning faces of the guests, you realize it’s going to
                  take drastic measures to salvage any excitement out of this
                  long night. So you sneak a desperate gulp of your drink, slip
                  on your tinted sunglasses and leap atop of the sofa. You’ve
                  sacrificed yourself to karaoke.
                </h6>
              </Col>
              <Col xl={6} lg={6} md={6} sm={12} xs={12}>
                ...
                <h6 className={Style.Blogpart_h6}>
                  The birth of Memphis Design was a lot like this, starting with
                  a gathering of architects and industrial designers in Milan,
                  Italy in 1981. But it wasn’t the party that bored the guests.
                  It was the general state of design—how creativity had
                  stagnated to become corporate and uniform.
                </h6>
              </Col>
              <Col xl={6} lg={6} md={6} sm={12} xs={12}>
                <Image
                ...
                <h6 className={Style.Blogpart_h6}>
                  ...
                  were likely on the guests’ minds as they traced where it all
                  had gone wrong. Kadinsky composition On White Kadinsky’s work
                  also likely inspired the Memphis design movement.
                </h6>
              </Col>
            </Row>
          </Col>
          ...
          >
            ...
            <div className={Style.Blogpart_categories_div}>
              ...
              <div className={Style.Blogpart_categories_2div}>
                <h6 className={Style.Blogpart_categories_2div_h3}>Business</h6>
                <div className={Style.Blogpart_categories_div_numdiv}>
                  <h6 className={Style.Blogpart_categories_2div_h3_num}>05</h6>
                </div>
              </div>
              <div className={Style.Blogpart_categories_2div}>
                ...
                <div className={Style.Blogpart_categories_div_numdiv}>
                  <h6 className={Style.Blogpart_categories_2div_h3_num}>15</h6>
                </div>
              </div>
              <div className={Style.Blogpart_categories_2div}>
                <h6 className={Style.Blogpart_categories_2div_h3}>
                ...
                <div className={Style.Blogpart_categories_div_numdiv}>
                  <h6 className={Style.Blogpart_categories_2div_h3_num}>65</h6>
                </div>
              </div>
              <div className={Style.Blogpart_categories_2div}>
                <h6 className={Style.Blogpart_categories_2div_h3}>
                ...
                <div className={Style.Blogpart_categories_div_numdiv}>
                  <h6 className={Style.Blogpart_categories_2div_h3_num}>08</h6>
                </div>
              </div>
              <div className={Style.Blogpart_categories_2div}>
                <h6 className={Style.Blogpart_categories_2div_h3}>
                ...
                <div className={Style.Blogpart_categories_div_numdiv}>
                  <h6 className={Style.Blogpart_categories_2div_h3_num}>16</h6>
                </div>
              </div>
            </div>
            <div className={Style.Blogpart_categories_div_secound}>
              <h3 className={Style.Blogpart_categories_div_secound_h3}>Tags</h3>
