  ...
  return (
    <>
      <div className="contactus_div">
        ...
        <Container>
          <Row>
            <Col
              ...
              xs={{ span: 12, order: 1 }}
            >
              <Image src="./Image (13).png" className="fromdiv-1 mt-5" />
            </Col>
            <Col
              xl={6}
              lg={6}
        ...
        <Container>
          <Image src="./Map.png" className="container_3-img" />
        </Container>
        <Container className="d-flex justify-content-around w-100">
          <Image src="./Group.svg" className="contactus_last-img" />
          <Image src="./Group (1).svg" className="contactus_last-img" />
          <Image src="./Group (2).svg" className="contactus_last-img" />
          <Image src="./Group (3).svg" className="contactus_last-img" />
        </Container>
      </div>
    </>
  );
